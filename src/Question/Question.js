...
const Question = () => {
    ...
    <p className='text-center py-3 text-lg'>React is a JavaScript library (not a framework) that creates user interfaces (UIs) in a predictable and efficient way using declarative code. <br /> You can use it to help build single page applications and mobile apps, or to build complex apps if you utilise it with other</p>
  </div>
            </div>
    ...
    <p className='text-center py-3 text-lg'>Data Cannot be Changed through  props, only data is sent through  props...! Properties are called props on the language of React, <br /> One thing that can be changed is when the user clicks, interacts with the page
     </p>
  </div>
            </div>
